...
<div className='Supp' style={{height:'fit-content',width:'90%',border:'1px solid purple',margin:'auto',minHeight:"400px",margin:"auto",backgroundColor:"#282C34",boxShadow:"0px 5px 15px #9CA3AF"}} > 
<br />
<h1 style={{color:'white',marginLeft:'33%'}}>INDIA HISTORICAL STATS</h1>
<br />
<Line
  data={data}
  options={options}
...
<br />
<div className="btnx">
<button className="btn mr-2"  onClick={()=>{setType("dailyconfirmed")}}>infected</button>
<button className="btn mr-2" onClick={()=>{setType("dailydeceased")}}>deceased</button>
<button className="btn mr-2"  onClick={()=>{setType("dailyrecovered")}}>recovered</button>
</div>
</div>
<br /><br /><br />

  <div style={{width:"90%",minHeight:"1300px",backgroundColor:"#282c34",boxShadow:"0px 5px 15px #9CA3AF",margin:"auto",border:'1px solid purple'}}>
  <br />
  <br />
  <h1 style={{color:'white',marginLeft:'33%'}}>INDIA STATE-WISE STATS</h1>
  <br />
 <br />
